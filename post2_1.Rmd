...
![alt text here](C:/Users/selly/Google Drive/UT/STAT576/STAT576_1/dendrogram.png)
...
PC1= ![alt text here](C:/Users/selly/Google Drive/UT/STAT576/STAT576_1/pc.png)
...
Let's re-order for easier interpretation.
```{r}
#print(levels(dat[,1]))
...
```
It seems that two variables, duration and RMS are associated with threat level.
